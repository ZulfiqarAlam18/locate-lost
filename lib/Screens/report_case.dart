              ...
              children: [
                ...
                RichText(
                  ...
                  text: TextSpan(
                    ...
                    style: TextStyle(color: Colors.black,fontFamily: 'Poltawski Nowy', fontSize: 25,fontStyle:FontStyle.italic,fontWeight: FontWeight.w500), // Default style
                    children: [
                        ...
                        child: SizedBox(
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                Image.asset('assets/link-03.png', width: 40, height: 40),
                                const SizedBox(height: 8),
                                const Text(
                                  'Report a',
                                  style: TextStyle(color: Colors.white, fontSize: 15, fontWeight: FontWeight.w600),
