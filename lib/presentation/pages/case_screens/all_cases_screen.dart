...
class _AllCasesScreenState extends State<AllCasesScreen> {
  ...
  void initState() {
    super.initState();
    // Load any submitted cases
    controller.loadSubmittedCases();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Obx(() {
        if (controller.submittedCases.isEmpty) {
  ...
  Widget _buildCasesList() {
    return RefreshIndicator(
      ...
      child: ListView.builder(
        ...
        itemCount: controller.submittedCases.length,
        itemBuilder: (context, index) {
          final caseData = controller.submittedCases[index];
  ...
  Widget _buildCaseCard(ParentReport caseData, int index) {
    return Container(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildInfoRow(Icons.person, 'Age', '${caseData.age} years old'),
            _buildInfoRow(Icons.location_on, 'Last Seen', caseData.placeLost),
            _buildInfoRow(Icons.access_time, 'Reported', _formatDateTime(caseData.createdAt)),
  ...
  void _viewCaseDetails(ParentReport caseData) {
    Get.snackbar(
      'Case Details',
      'Viewing details for ${caseData.childName}',
  ...
  void _shareCaseInfo(ParentReport caseData) {
    Get.snackbar(
      'Share Case',
      'Sharing case information for ${caseData.childName}',
      snackPosition: SnackPosition.BOTTOM,
      backgroundColor: AppColors.primary,
      colorText: Colors.white,
    );
